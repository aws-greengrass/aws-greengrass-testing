...
public class ClasspathComponentPreparationServiceTest {
    ...
    @Test
    void GIVEN_a_ClasspathComponentPreparationService_class_inherits_RecipeComponentPreparationService_class_WHEN_a_FileComponentPreparationService_instance_is_initialized_THEN_it_inherit_properly() {
        assertEquals(classpathComponentPreparationService.getClass().getSuperclass().getName(), RecipeComponentPreparationService.class.getName());
    }
}
